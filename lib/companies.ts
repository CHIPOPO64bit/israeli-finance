...
export const COMPANIES: Company[] = [
  ...
  { symbol: 'IBI.TA',                          englishName: 'IBI Investment House',       hebrewName: 'איי.בי.איי. בית השקעות',       shortName: 'IBI',         sector: 'fintech',    tagline: 'Brokerage, underwriting, asset management',       founded: 1971, hq: 'Tel Aviv',     website: 'ibi.co.il' },
  { symbol: 'MTAV.TA',                         englishName: 'Meitav Investment House',    hebrewName: 'מיטב בית השקעות',             shortName: 'Meitav',      sector: 'fintech',    tagline: 'Provident, pension, mutual-fund management',      founded: 1979, hq: 'Bnei Brak',    website: 'meitav.co.il' },
  { symbol: 'MNIF.TA',                         englishName: 'Menif Financial Services',   hebrewName: 'מניף שירותים פיננסיים',        shortName: 'Menif',       sector: 'fintech',    tagline: 'SME factoring, leasing & credit',                 founded: 2007, hq: 'Tel Aviv',     website: 'menif.co.il' },
  { symbol: 'MISH.TA',                         englishName: 'Mivtach Shamir Holdings',    hebrewName: 'מבטח שמיר אחזקות',            shortName: 'Mivtach Shamir', sector: 'fintech', tagline: 'Diversified investment holding company',         founded: 1985, hq: 'Tel Aviv',     website: 'mivtach-shamir.co.il' },

  // ── Ardan Watchlist (TASE small/mid-cap value names) ──────────────
  // Curated from Shlomi Ardan's value-investor research universe. These are
  // names that fall outside the TA-35 mainstream but show up consistently
  // in deep-value Israeli portfolios. Hebrew names use the official TASE form.
  { symbol: 'ACCL.TA',                         englishName: 'Accel Solutions Group',      hebrewName: 'אקסל סולושנס',                shortName: 'Accel',       sector: 'industrial', tagline: 'IT integration, infrastructure & services',       hq: 'Israel' },
  { symbol: 'ARIN.TA',                         englishName: 'Ari Real Estate (Arena)',    hebrewName: 'ארי נדל"ן (ארנה)',            shortName: 'Ari RE',      sector: 'realestate', tagline: 'Income-producing real estate & development',      hq: 'Tel Aviv' },
  { symbol: 'GAGR.TA',                         englishName: 'Gaon Group',                 hebrewName: 'גאון אחזקות',                 shortName: 'Gaon',        sector: 'industrial', tagline: 'Water systems, infrastructure & holdings',        hq: 'Israel' },
  { symbol: 'GLTL.TA',                         englishName: 'Gilat Telecom Global',       hebrewName: 'גילת טלקום גלובל',            shortName: 'Gilat Telecom', sector: 'telecom',  tagline: 'B2B telecom services (Israel + Africa)',          founded: 2001, hq: 'Petah Tikva',  website: 'gilat-telecom.co.il' },
  { symbol: 'TLSY.TA',                         englishName: 'Telsys',                     hebrewName: 'טלסיס',                       shortName: 'Telsys',      sector: 'semis',      tagline: 'Electronic component distribution & embedded',    founded: 1985, hq: 'Bnei Brak',    website: 'telsys.co.il' },
  { symbol: 'TRX.TA',                          englishName: 'Terminal X Online',          hebrewName: 'טרמינל איקס אונליין',         shortName: 'Terminal X',  sector: 'retail',     tagline: 'Online fashion retailer (Fox-Wizel subsidiary)',  founded: 2013, hq: 'Airport City' },
  { symbol: 'MLTM.TA',                         englishName: 'Malam-Team',                 hebrewName: 'מלם-תים',                     shortName: 'Malam-Team',  sector: 'tech',       tagline: 'IT services, outsourcing & integration',          founded: 2008, hq: 'Petah Tikva',  website: 'malam-team.com' },
  { symbol: 'CMER.TA',                         englishName: 'C. Mer Industries',          hebrewName: 'ש. מר תעשיות',                shortName: 'C.Mer',       sector: 'defense',    tagline: 'Defense electronics, secure comms, fiber-optics', founded: 1988, hq: 'Bnei Brak',    website: 'cmer.com' },
  { symbol: 'NVPT.TA',                         englishName: 'Navitas Petroleum LP',       hebrewName: 'נביטס פטרוליום',              shortName: 'Navitas',     sector: 'energy',     tagline: 'Gulf-of-Mexico oil & gas exploration',            founded: 2010, hq: 'Tel Aviv',     website: 'navitaspetroleum.com' },
  { symbol: 'NXTM.TA',                         englishName: 'Nextcom',                    hebrewName: 'נקסטקום',                     shortName: 'Nextcom',     sector: 'telecom',    tagline: 'Telecom infrastructure deployment services',      hq: 'Israel' },
  { symbol: 'SOFW.TA',                         englishName: 'Sofwave Medical',            hebrewName: 'סופוויב מדיקל',               shortName: 'Sofwave',     sector: 'pharma',     tagline: 'Non-invasive ultrasound medical aesthetics',      founded: 2018, hq: "Yokne'am",     website: 'sofwave.com' },
  { symbol: 'FOX.TA',                          englishName: 'Fox-Wizel',                  hebrewName: 'פוקס-ויזל',                   shortName: 'Fox',         sector: 'retail',     tagline: 'Fashion retail (Fox, American Eagle, Foot Locker IL)', founded: 1942, hq: 'Airport City', website: 'fox.co.il' },
  { symbol: 'QLTU.TA',                         englishName: 'Qualitau',                   hebrewName: 'קווליטאו',                    shortName: 'Qualitau',    sector: 'semis',      tagline: 'Wafer-level reliability test equipment',          founded: 1985, hq: 'Carmiel',      website: 'qualitau.com' },
  { symbol: 'SHOM.TA',                         englishName: 'E.N. Shoham Business',       hebrewName: 'א.נ. שוהם ביזנס',             shortName: 'Shoham',      sector: 'realestate', tagline: 'Real-estate development & business services',     hq: 'Israel' },
];
